    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 p-4">
      ...
      >
        ...
        >
          <Link
            href="/resume"
            className="px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-lg font-medium min-w-[200px] text-center"
          >
            이력서 보기
          </Link>
          <Link
            href="/portfolio"
            className="px-8 py-3 bg-gray-700 text-white rounded-lg hover:bg-gray-600 transition-colors text-lg font-medium min-w-[200px] text-center"
          >
            포트폴리오 보기
          </Link>
        </div>
